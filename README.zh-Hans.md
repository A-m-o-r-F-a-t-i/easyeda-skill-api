> API Skill 2.5.0：常见 PCB 操作优先使用 PCB MCP 4.1.0，常规 PCB 几何固定为 mil，17 个工具仅保留当前契约。此 Skill 用于明确的能力缺口、扩展开发与 Bridge 诊断，入口为 [SKILL.md](SKILL.md)。下文原生 API 示例是上游开发参考，不是日常 PCB 编辑路径。
